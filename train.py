...
best_string = ["ALL", "old", "new"]
best = [[0 for _ in range(3)] for _ in range(3)]
    ...
    for epoch in range(args.epochs):
        ...
        for batch_idx, batch in enumerate(train_loader):
            ...
            with torch.cuda.amp.autocast(fp16_scaler is not None):
                ...
                loss +=  args.sup_weight * sup_con_loss
        ...
        if best[0][0] < all_acc:
            best[0][0], best[0][1], best[0][2] = all_acc, old_acc, new_acc
        if best[1][1] < old_acc:
            best[1][0], best[1][1], best[1][2] = all_acc, old_acc, new_acc
        if best[2][2] < new_acc:
            best[2][0], best[2][1], best[2][2] = all_acc, old_acc, new_acc
        for i, string in enumerate(best_string):
            print(string, ':', best[i])
